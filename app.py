...
x = df_encoded.drop(columns=['deficient', 'vitamin_d_ng_ml', 'supplement_tier', 'sun_hours_bins', 'sun_exposure_group', 'sun_hours_quartile'])
...
x_full = df_encoded.drop(columns=['deficient', 'vitamin_d_ng_ml', 'supplement_tier', 'sun_hours_bins', 'sun_exposure_group', 'sun_hours_quartile']).copy()
